...
public class LogoutServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		session.removeAttribute("holiday");
		session.removeAttribute("after_syukkin");
		session.removeAttribute("after_taikin");
		session.removeAttribute("remarks");
		session.removeAttribute("process_name");
		session.removeAttribute("total_actual");
		session.removeAttribute("total_overtime");
		session.removeAttribute("display_date");
		session.removeAttribute("total");
		session.removeAttribute("monthValue");
		session.removeAttribute("mhList");
