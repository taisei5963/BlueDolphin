...
@WebServlet("/OvertimeRequestProcessServlet")
public class OvertimeRequestProcessServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(OvertimeRequestProcessServlet.class);
	...
	private static final String OVERTIMEREQUESTNAME = "残業申請";
	private static final String EARLYREQUESTNAME = "早出申請";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(APPROVALPROCESS.equals(process)) {
			...
			switch(kind_overtime) {
			case OVERTIMEREQUESTNAME:
				try {
					aadao.dbConenect();
					aadao.createSt();
					adao.dbConenect();
