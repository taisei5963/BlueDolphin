...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/various_applications_completed.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				 <div class="div" align="center">
                	...
                	<p class="content1">申請を提出いたしました。<br>承認されるまでしばらくお待ちください。</p>
                	<a href="./various_applications_view.jsp" class="link_button">戻る</a>
                </div>
			</div>
