...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/leave_early_request_view.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				...
				<div class="div" align="center">
					<form action="LeaveEarlyRequestProcessServlet" method="post">
	                	<h2 class="context">早退申請</h2>
	                    ...
	                    <table class="table1" border="1">
                            ...
                            <tr class="table1_tr3">
                                <td class="table1_tr3_td1">退勤時間</td>
