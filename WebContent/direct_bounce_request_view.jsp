...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/direct_bounce_request_view.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				...
				<div class="div" align="center">
					<form action="DirectBounceRequestProcessServlet" method="post">
	                	<h2 class="context">直行直帰申請</h2>
	                    ...
	                    <table class="table1" border="1">
                            ...
                            <tr class="table1_tr4">
                                ...
                                <td class="table1_tr4_td3">
                                    <input type="radio" name="kind_direct_bounce" class="table1_tr4_td3_radio1" value="直行申請" checked>直行　　　
                                    <input type="radio" name="kind_direct_bounce" class="table1_tr4_td3_radio2" value="直帰申請">直帰　　　
                                    <input type="radio" name="kind_direct_bounce" class="table1_tr4_td3_radio2" value="直行直帰申請">直行直帰
                                </td>
                            </tr>
                            <tr class="table1_tr2">
