...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/holiday_work_request_view.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				...
				<div class="div" align="center">
					<form action="HolidayWorkRequestProcessServlet" method="post" name="holidayWorkForm">
	                	<h2 class="context">休日出勤申請</h2>
	                    ...
	                    <table class="table1" border="1">
                            ...
                            <tr class="table1_tr3">
                                <td class="table1_tr3_td1">作業時間</td>
                                <td class="table1_tr3_td2">
                                    <span class="table1_tr2_td2_span">必須</span>
                                </td>
                                <td class="table1_tr3_td3">
                                    <input type="time" name="startTime" id="start" value="00:00" class="table1_tr3_td3_time1">　〜　
                                    <input type="time" name="endTime" id="end" value="00:00" class="table1_tr3_td3_time2">
                                </td>
                            </tr>
                            <tr class="table1_tr4">
                                <td class="table1_tr4_td1">代休取得有無</td>
                                <td class="table1_tr4_td2">
                                    <span class="table1_tr2_td2_span">必須</span>
                                </td>
                                <td class="table1_tr4_td3">
                                	<% if("取得する".equals(holiday)) { %>
                                		<input type="radio" name="holiday" class="table1_tr4_td3_radio1" value="取得する" onclick="document.holidayWorkForm.submit()" checked>取得する
                                    　　　
                                    	<input type="radio" name="holiday" class="table1_tr4_td3_radio2" value="取得しない" onclick="document.holidayWorkForm.submit()">取得しない
                                	<% } else if("取得しない".equals(holiday)) { %>
                                		<input type="radio" name="holiday" class="table1_tr4_td3_radio1" value="取得する" onclick="document.holidayWorkForm.submit()">取得する
                                    　　　
                                    	<input type="radio" name="holiday" class="table1_tr4_td3_radio2" value="取得しない" onclick="document.holidayWorkForm.submit()" checked>取得しない
                                	<% } else { %>
                                		<input type="radio" name="holiday" class="table1_tr4_td3_radio1" value="取得する" onclick="document.holidayWorkForm.submit()">取得する
                                    　　　
                                    	<input type="radio" name="holiday" class="table1_tr4_td3_radio2" value="取得しない" onclick="document.holidayWorkForm.submit()">取得しない
                            ...
                            <% if("取得する".equals(holiday)) { %>
                            	<tr class="table1_tr5">
	                                <td class="table1_tr5_td1">代休取得日</td>
	                                <td class="table1_tr5_td2">
	                                    <span class="table1_tr2_td2_span">必須</span>
	                                </td>
	                                <td class="table1_tr5_td3">
	                                    <input type="text" name="holiday_acquisition_date" class="text_class" value="" required>
	                                    <div class="appendDatepicker1"></div>
	                                </td>
	                            </tr>
                            <% } else {} %>
                            <tr class="table1_tr6">
                                ...
                                <td class="table1_tr6_td3">
                                    <textarea name="application_reason" class="table1_tr6_td3_textarea" cols="50" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr class="table1_tr7">
