                    ...
                    <table class="table1">
                        ...
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">休日出勤申請</a>
                            </td>
                            <td class="table1_tr2_td2">自社内、現場先で休日出勤が発生した場合に使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">残業申請</a>
                            </td>
                            <td class="table1_tr2_td2">
                            ノー残業デーのときや21時以降まで残業が発生する場合に使用する。
                            <br>※基本的には定時退社を基本とし、リリース月等でいか仕方なく残業する場合に使用する。
                            </td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">早朝出勤申請</a>
                            </td>
                            <td class="table1_tr2_td2">定刻前に作業を行う場合に使用する。<br>※基本的に使用禁止とする。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">振替出勤申請</a>
                            </td>
                            <td class="table1_tr2_td2">業務上の都合で休日出勤の予定がある場合に、
                            あらかじめ休日と定められていた日を労働日に変更し、<br>
                            かわりに他の労働日を休日とする場合に使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">勤務時間変更申請</a>
                            </td>
                            <td class="table1_tr2_td2">現場先が変更になり、新たな勤務時間となったときに使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">遅刻申請</a>
                            </td>
                            <td class="table1_tr2_td2">体調不良などで出勤時間に遅れが発生する場合に使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">早退申請</a>
                            </td>
                            <td class="table1_tr2_td2">体調不良などで退勤時間より早く帰宅する場合に使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">直行直帰申請</a>
                            </td>
                            <td class="table1_tr2_td2">自宅から直接営業先に向かう場合や、営業先から直接帰路に着く場合に使用する。<br>※上長に直接で電話で連絡を入れた場合は、本申請は不要とする。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">工数申請</a>
                            </td>
                            <td class="table1_tr2_td2">従業員の１ヶ月分の作業工数を申請する場合に使用する。</td>
                        </tr>
                        <tr class="table1_tr2">
                            <td class="table1_tr2_td1" align="right">
                                <a href="#" class="table1_tr2_td1_link1">承認申請取消</a>
                            </td>
                            <td class="table1_tr2_td2">従業員が申請した内容の取消を行う場合に使用する。</td>
                        </tr>
                    </table>
                </div>
			</div>
