...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/overtime_request_details_view.css">
						...
						<form action="ApprovalRejectedDetailsServlet" method="post">
	                    	...
	                    	<table class="table1" border="1">
	                            <tr class="table1_tr1" align="center">
	                                ...
	                                <th class="table1_tr1_th5" align="center" width="150">総稼働時間</th>
	                                <th class="table1_tr1_th6" align="center" width="100">総残業時間</th>
	                                <th class="table1_tr1_th7" align="center" width="100">備考</th>
	                                <th class="table1_tr1_th8" align="center" width="100">申請状況</th>
	                            </tr>
	                            <% for(ApplicationContentsBean acb : appList) { %>
	                            	<tr class="table1_tr2" align="center">
		                                ...
		                                <!-- 総残業時間 -->
		                                <td class="table1_tr2_td6"><%= acb.getTotalOvertimeHours() %></td>
		                                <!-- 備考 -->
