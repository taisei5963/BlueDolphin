...
<html>
	<head>
		<title>工数実績登録完了｜BlueDolphin</title>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/transportation_expenses_completed.css">
	...
	<body class="body">
		...
		<div class="tab-content">
			...
			<div id="./transportation_expenses_view.jsp" class="tab-content active">
                ...
                <h2 align="center" class="head2">交通費精算登録完了</h2>
                <h5 align="center" class="head5">登録処理が正常に完了いたしました。</h5>
                <div align="center">
                	<button type="button" onclick="location.href='./transportation_expenses_view.jsp'" class="button_return">戻る</button>
                </div>
			</div>
