...
<%
	...
	//セッションリスト情報のNULLチェック
	if(userlist == null || appList == null || mhList == null){
...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/man_hour_request_details_view.css">
						...
						<form action="ApprovalRejectedDetailsServlet" method="post">
	                    	...
	                    	<table class="table1" border="1">
	                            <tr class="table1_tr1" align="center">
	                                ...
	                                <th class="table1_tr1_th5" align="center" width="150">総工数</th>
	                                <th class="table1_tr1_th6" align="center" width="100">申請状況</th>
	                            </tr>
	                            <% for(ApplicationContentsBean acb : appList) { %>
	                            	<tr class="table1_tr2" align="center">
			                            ...
			                            <!-- 総工数 -->
			                            <td class="table1_tr2_td5"><%= acb.getTotalUptime() %></td>
			                            <!-- 申請状況 -->
		                                ...
		                                <% } else { %>
		                                	<td class="table1_tr2_td6"><%= acb.getApplicationStatus() %></td>
		                                <% } %>
		                            </tr>
	                            <% } %>
	                            <tr class="table1_tr3" align="center">
		                                <td colspan="9" class="table1_tr3_td1">日にち</td>
	                            </tr>
                            	<tr class="table1_tr3" align="center">
