						...
						<form action="ApprovalRejectedDetailsServlet" method="post">
	                    	...
	                    	<table class="table1" border="1">
	                            <tr class="table1_tr1" align="center">
	                                ...
	                                <th class="table1_tr1_th3" align="center" width="250">対象日</th>
	                                <th class="table1_tr1_th4" align="center" width="150">休暇種類</th>
	                                <th class="table1_tr1_th5" align="center" width="100">取得時間</th>
	                                <th class="table1_tr1_th6" align="center" width="150">申請理由</th>
	                            ...
	                            <% for(ApplicationContentsBean acb : appList) { %>
	                            	<tr class="table1_tr2" align="center">
			                            ...
			                            <!-- 取得時間 -->
			                            <td class="table1_tr2_td5"><%= acb.getAcquisitionTime() %></td>
		                                <!-- 申請理由 -->
		                                <td class="table1_tr2_td6"><%= acb.getApplicationReason() %></td>
		                                <!-- 申請状況 -->
		                                <% if("申請中".equals(acb.getApplicationStatus())) { %>
		                                	<td class="table1_tr2_td7">
		                                		<span style="color: red; font-size: 20px; font-weight: 800"><%= acb.getApplicationStatus() %></span>
		                                	</td>
		                                <% } else { %>
	                            ...
	                            <% } %>
	                            <tr class="table1_tr3">
	                                <td colspan="8" class="table1_tr3_td1"></td>
	                            </tr>
