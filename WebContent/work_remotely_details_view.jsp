...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/work_remotely_details_view.css">
						...
						<form action="ApprovalRejectedDetailsServlet" method="post">
	                    	...
	                    	<table class="table1" border="1">
	                            <tr class="table1_tr1" align="center">
	                                ...
	                                <th class="table1_tr1_th6" align="center" width="300">作業内容</th>
	                                <th class="table1_tr1_th7" align="center" width="100">作業時間(予定)</th>
	                                <th class="table1_tr1_th8" align="center" width="100">連絡先</th>
	                                <th class="table1_tr1_th9" align="center" width="100">申請状況</th>
	                            </tr>
	                            <% for(ApplicationContentsBean acb : appList) { %>
	                            	<tr class="table1_tr2" align="center">
		                                ...
		                                <!-- 作業内容 -->
		                                <td class="table1_tr2_td6"><%= acb.getWorkContents() %></td>
		                                <!-- 作業時間(予定) -->
		                                <td class="table1_tr2_td7"><%= acb.getWorkingHours() %></td>
		                                <!-- 連絡先 -->
		                                <td class="table1_tr2_td8"><%= acb.getContact() %></td>
		                                <!-- 申請状況 -->
		                                <% if("申請中".equals(acb.getApplicationStatus())) { %>
		                                	<td class="table1_tr2_td9">
		                                		<span style="color: red; font-weight: 600"><%= acb.getApplicationStatus() %></span>
		                                	</td>
		                                <% } else { %>
		                                	<td class="table1_tr2_td9"><%= acb.getApplicationStatus() %></td>
		                                <% } %>
		                            </tr>
	                            <% } %>
	                            <tr class="table1_tr3">
