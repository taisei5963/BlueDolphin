...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/delete_account_search.css">
		...
		<div class="tab-content">
			...
			<% if(authority == 2) { %>
				...
				<div id="./delete_account_search.jsp" class="tab-pane active">
					...
					<h5 align="center" class="head5">削除したい従業員番号を入力してください。</h5>
	                        ...
	                        <table class="table1">
	                            <tr class="table1_tr1">
	                                ...
	                                <td class="table1_tr1_td2">
	                                    <input type="text" name="emp_num" size="10" maxlength="10">
	                                </td>
	                            </tr>
                            </table>
