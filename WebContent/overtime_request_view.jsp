...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/overtime_request_view.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				...
				<div class="div" align="center">
					<form action="OvertimeRequestProcessServlet" method="post">
	                	<h2 class="context">早出・残業申請</h2>
	                    ...
	                    <table class="table1" border="1">
                            ...
                            <tr class="table1_tr4">
                                <td class="table1_tr4_td1">種別</td>
                                <td class="table1_tr4_td2">
                                    <span class="table1_tr2_td2_span">必須</span>
                                </td>
                                <td class="table1_tr4_td3">
                                    <input type="radio" name="kind_overtime" class="table1_tr4_td3_radio1" value="早出申請">早出残業　　　
                                    <input type="radio" name="kind_overtime" class="table1_tr4_td3_radio2" value="残業申請" checked>通常残業
                                </td>
                            </tr>
                            <tr class="table1_tr2">
                            ...
                            <tr class="table1_tr3">
                                <td class="table1_tr3_td1">残業時間</td>
                                <td class="table1_tr3_td2">
                                    <span class="table1_tr2_td2_span">必須</span>
                                </td>
                                <td class="table1_tr3_td3">
                                    <input type="time" name="startTime" value="00:00" class="table1_tr3_td3_time1">　〜　
                                    <input type="time" name="endTime" value="00:00" class="table1_tr3_td3_time2">
                                </td>
                            </tr>
                            <tr class="table1_tr6">
