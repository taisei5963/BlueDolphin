...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/man_hour_error.css">
	...
	<body class="body">
		...
		<div class="tab-content">
			...
			<div id="./KinmuhyoServlet" class="tab-pane active">
				...
				<% if("削除失敗".equals(process)) { %>
					<h5 class="head5" align="center">指定の工数項目の削除が失敗しました。</h5>
					<input type="button" value="戻る" onclick="location.href='./KinmuhyoServlet'" class="button_back">
				<% } else if("登録失敗".equals(process)) { %>
					<h5 class="head5" align="center">指定の工数情報の登録が失敗しました。</h5>
					<input type="button" value="戻る" onclick="location.href='./KinmuhyoServlet'" class="button_back">
				<% } %>
			</div>
