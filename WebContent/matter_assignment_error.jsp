...
<html>
	<head>
		<title>案件アサイン失敗｜BlueDolphin</title>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/matter_assignment_error.css">
	...
	<body class="body">
		...
		<div class="tab-content">
			...
			<div id="./KinmuhyoServlet" class="tab-pane active">
				...
				<h5 class="head5" align="center">案件アサインに失敗しました。</h5>
				<input type="button" value="戻る" onclick="location.href='./matter_assignment_view.jsp'" class="button_back">
			</div>
