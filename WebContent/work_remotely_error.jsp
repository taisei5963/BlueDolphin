...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/work_remotely_error.css">
	...
	<body class="body">
		...
		<div class="tab-content">
			...
			<div id="./WorkRemotelyViewServlet" class="tab-content active">
				<h4 class="head4">在宅勤務申請【エラー】</h4>
				<div align="center">
	                <p class="content1">エラーが発生したため、申請が行えませんでした。</p>
	                <a href="./WorkRemotelyViewServlet" class="link_button">戻る</a>
                </div>
			</div>
			<% if(authority == 1) { %>
