		...
		<form action="LoginServlet" method="POST">
			<table class="body_table">
	            ...
	            <tr class="body_table_tr2">
	                <td class="body_table_tr2_td">
	                	<input class="body_table_tr2_td_input" type="email" name="mail" maxlength="40" size="40" value="<%= email %>">
	                </td>
	            </tr>
	            ...
	            <tr class="body_table_tr4">
	                <td class="body_table_tr4_td">
	                	<input class="body_table_tr4_td_input" type="password" name="pass" maxlength="20" size="40">
	                </td>
	            </tr>
	            <tr class="body_table_tr6">
	                <td class="body_table_tr6_td" align="center">
	                	<input class="body_table_tr6_td_input" type="submit" value="ログイン">
	                </td>
	            </tr>
	    	</table>
		</form>
