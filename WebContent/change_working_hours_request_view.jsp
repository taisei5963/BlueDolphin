<%@page import="Bean.WorkPatternBean"%>
...
<%
	...
	@SuppressWarnings("unchecked")
	ArrayList<WorkPatternBean> patternList = (ArrayList<WorkPatternBean>)session.getAttribute("patternList");
...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/change_working_hours_request_view.css">
		...
		<div class="tab-content">
			...
			<div id="./various_applications_view.jsp" class="tab-content active">
				...
				<div class="div" align="center">
					<form action="ChangeWorkHoursRequestProcessServlet" method="post">
	                	<h2 class="context">勤務時間変更申請</h2>
	                    ...
	                    <table class="table1" border="1">
                            ...
                            <tr class="table1_tr3">
                                <td class="table1_tr3_td1">勤務パターン</td>
                                <td class="table1_tr3_td2">
                                    <span class="table1_tr2_td2_span">必須</span>
                                </td>
                                <td class="table1_tr3_td3">
                                	<select name="work_pattern" class="table1_tr3_td3_select">
                                		<option value="">選択してください</option>
                                    <% for(WorkPatternBean wpb : patternList) { %>
                                    	<option value="<%= wpb.getPatternName() %>"><%= wpb.getPatternName() %></option>
                                    <% } %>
                                    </select>
                                </td>
                            </tr>
                            <tr class="table1_tr6">
                                <td class="table1_tr6_td1">期間</td>
                                <td class="table1_tr6_td2"></td>
                                <td class="table1_tr6_td3">
                                	<input type="date" name="start_date" class="table1_tr6_td3_date1">　〜　
                                    <input type="date" name="end_date" class="table1_tr6_td3_date2">
                                </td>
                            </tr>
                            <tr class="table1_tr7">
