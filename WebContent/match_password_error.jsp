...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="common/css/match_password_error.css">
<title>パスワード変更エラー｜BlueDolphin</title>
</head>
<body>
	<div id="header">
	...
	<div class="sub1" align="center">
		...
		<form action="ChangePasswordServlet" method="post">
			...
			<p class="error1" align="center">入力したパスワードと確認用が一致しませんでした。</p>
