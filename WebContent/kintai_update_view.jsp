...
<%
	...
	AttendanceUpdateViewServlet auv = new AttendanceUpdateViewServlet();
		...
		<div class="main_header">
			...
			<main class="p-3">
				<ul class="nav nav-tabs" style="margin-left: 130px; margin-top: -46px;">
					...
					<li class="nav-item">
						<a href="#tab4" class="nav-link active">各種申請</a>
					</li>
					<li class="nav-item">
					...
					<div align="center">
						...
						<table border="1">
							<tr>
								...
								<td align="center" colspan="3"><%= year + "年" + month + "月" + date + "日　" + auv.getYobi(thisMonth) %></td>
							</tr>
							<tr>
						...
						<input type="button" value="戻る" class="backButton" onclick="location.href='./KinmuhyoServlet'">
						<input type="submit" value="申請" class="submitButton">
					</div>
				</form>
			</div>
