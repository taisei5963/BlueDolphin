...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="common/css/change_working_hours_request_details_view.css">
			...
			<% if(authority == 1) { %>
				<div id="./ApprovalRejectedViewServlet" class="tab-content active">
					...
					<div class="div" align="center">
						<form action="ChangeWorkHoursRequestDetailsServlet" method="post">
	                    	...
	                    	<table class="table1" border="1">
	                            <tr class="table1_tr1" align="center">
	                                ...
	                                <th class="table1_tr1_th5" align="center" width="150">勤務パターン</th>
	                            ...
	                            <% for(ApplicationContentsBean acb : appList) { %>
	                            	<tr class="table1_tr2" align="center">
			                            ...
			                            <!-- 勤務パターン -->
			                            <td class="table1_tr2_td5"><%= acb.getWorkContents() %></td>
		                                <!-- 申請状況 -->
