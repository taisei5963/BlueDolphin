	...
	<body class="body">
		...
		<div class="tab-content">
			...
			<div id="./WorkRemotelyServlet" class="tab-content active">
				<h4 class="head4">在宅勤務申請【申請完了】</h4>
                <p class="content1">承認申請が正常に完了いたしました。<br>承認されるまで、お待ちください。</p>
                <form action="WorkRemotelyViewServlet" method="post">
                	<input type="submit" value="申請内容入力画面へ" class="button_submit">
                </form>
			</div>
			<% if(authority == 1) { %>
